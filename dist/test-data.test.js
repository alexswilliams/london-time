...
26 27 28 29 30 31     23 24 25 26 27 28 29  28 29 30 31           
                      30                                          
`;
exports.datesInYear1900 = parseCalYear(year1900CalOutput);
exports.datesInYear2000 = parseCalYear(year2000CalOutput);
exports.datesInYear2020 = parseCalYear(year2020CalOutput);
exports.datesInYear2025 = parseCalYear(year2025CalOutput);
function parseCalYear(fullText) {
...
function parseCalMonth(monthLines, yearOverride) {
    ...
    const dates = dayNumbers.flatMap(line => [
        ...
        .filter(it => it.day !== '')
        .map(it => ({ dayOfWeek: it.dayOfWeek, date: `${yearMonth}-${zeroPad(it.day)}` })));
    return dates;
}
function zipWithNext(arr) {
    if (arr.length < 2)
        return [];
    const result = [];
    let last = arr[0];
